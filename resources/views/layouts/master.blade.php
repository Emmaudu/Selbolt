  ...
  <body style="background-color: #f8f8ff;">
		...
		<div class="wrapper d-flex align-items-stretch">
          ...
          <ul class="list-unstyled components mb-5">
            ...
            <li>
              <a href="{{route('mentor.profile-page')}}">
                <span class="fa fa-user mr-3 nav-link-text"></span>Profile
              </a>
            </li>
            <li>
              <a href="{{route('mentor.mentees')}}">
                <span class="fa fa-user mr-3 nav-link-text"></span>Mentees
              </a>
            </li>
            <li>
              <a href="{{route('mentor.questions')}}">
                <span class="fa fa-user mr-3 nav-link-text"></span>Questions
              </a>
            </li>
            <li>
              <a href="{{route('mentor.new-mentees')}}">
                <i class="ni ni-circle-08 text-pink"></i>
                <span class="fa fa-user mr-3 nav-link-text"></span>Approve Mentee
              </a>
            </li>
            <li>
              <a href="{{route('mentor.payment-mode')}}">
                <i class="ni ni-circle-08 text-pink"></i>
                <span class="fa fa-user mr-3 nav-link-text"></span>Transaction Details
              </a>
            </li>
            @auth
            <li>
