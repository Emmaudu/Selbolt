  ...
  <h1 id="text-color">ALL MENTORS</h1>
    ...
    <div class="row">
      @foreach($users as $user)
          <div class="col-lg-4">
            <a href="/admin/mentors/details/{{$user->id}}">
            <div class="pt-3">
              <div class="two">
                  ...
                  <div class="d-flex justify-content-start align-items-center"> <i class="mdi mdi-calendar-clock date"></i></div>
                      <div class="d-flex justify-content-start align-items-center">
                        <a href="/admin/mentors/deactivate/{{$user->id}}" class="btn btn-info" style="background-color: #191970;color: white">Deactivate Mentor</a>
                      </div>
