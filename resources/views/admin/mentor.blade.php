...
<div class="container mt--6">
  <h1 id="text-color">ALL MENTORS</h1>
    @if(!$users->isEmpty())
    <div class="row">
      @foreach($users as $user)
          <div class="col-lg-4">
            <a href="/admin/taskers/details/{{$user->id}}">
            <div class="pt-3">
              <div class="two">
                  ...
                  <div class="px-3 pt-3">
                      ...
                      <p class="quote2 p2">Mentee: {{$mentee->fullname()}}</p>
                      @endforeach
                  </div>
                  ...
                  <div class="d-flex justify-content-start align-items-center"> <i class="mdi mdi-calendar-clock date"></i></div>
                      <div class="d-flex justify-content-start align-items-center">
                        <a href="/admin/taskers/deactivate/{{$user->id}}" class="btn btn-info" style="background-color: #191970;color: white">Deactivate Mentor</a>
                      </div>
