...
<head>
  ...
  <title>Mentorships.ng | Mentor-Register</title>
  <!-- Favicon -->
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              <h1 class="text-white">Register as a mentor</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-12 col-md-12">
          <div class="card bg-secondary border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" method="post" action="{{route('register.mentor')}}">
                @csrf
                @if ($errors->any())
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                    ...
                    <input class="form-control" placeholder="Name" type="text" name="first_name">
                  </div>
                </div>
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative mb-3">
                ...
                <!-- MENTORSHIP QUESTION -->
                <h2>Mentorship Questions</h2>
                <hr style="margin-bottom: 15px;margin-top: 15px">
                <div class="form-group">
                  <small style="margin-bottom: 10px;">Comma-separated list of your skills (keep it below 10). Mentees will use this to find you.</small>
                  <div class="input-group input-group-merge input-group-alternative">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="ni ni-lock-circle-open"></i></span>
                    </div>
                ...
                <div class="form-group">
                  <small>We are encouraging you to set the price to 0.00 if you want to mentor for free. Remember that there is a 20% processing fee per transaction. Limit is NGN 10000/week</small>
                  <div class="input-group input-group-merge input-group-alternative">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="ni ni-lock-circle-open"></i></span>
                    </div>
                ...
                <div class="form-group">
                  <small>INTERVIEW: Why do you want to become a mentor? (Not publicly visible):</small>
                  <div class="input-group input-group-merge input-group-alternative">
                    <textarea class="form-control" name="why_a_mentor" rows="8"></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <small>INTERVIEW: What is your greatest career success so far? (Not publicly visible):</small>
                  <div class="input-group input-group-merge input-group-alternative">
                ...
                <!--SERVICES -->
                <h2>Services</h2>
                <small>Not require, update can still be made later</small>
                @foreach($services as $service)
                  @if($service->status == "general")
                    <div class="form-group">
                      <label class="label">{{$service->name}} <span style="color: red">*</span></label>
