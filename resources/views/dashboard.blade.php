...
<div style="color: #191970;"><b>Welcome, {{auth()->user()->fullname()}}<b></div>
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg mt-2">
            ...
            <div class="card-body">
                ...
                <span class="text-success mr-2"><i class="fa fa-arrow-up"></i> {{$pendingTransactions->count()}}</span>
        ...
        <div class="col-lg mt-2">
            ...
            <div class="card-body">
                ...
                <div class="col">
                    ...
                    <span class="h2 font-weight-bold mb-0">{{auth()->user()->mentors->count()}}</span>
                </div>
                <div class="col-auto">
                    <div class="icon icon-shape bg-gradient-red text-white rounded-circle shadow">
                    <i class="ni ni-active-40"></i>
                ...
                <p class="mt-3 mb-0 text-sm">
                <span class="text-success mr-2"><i class="fa fa-arrow-up"></i> {{$pendingTransactions->count()}}</span>
                <span class="text-nowrap">mentors</span>
                </p>
            </div>
            </div>
        </div>  
    ...
    <div class="row">
        <div class="offset-1"></div>
        <div class="mt-3 ml-3 p3"><b>
            <h3 style="color: #191970">Pending Transactions</h3></b>
        </div>
    </div>
    ...
    @foreach($pendingTransactions as $pendingTransaction)
        <div class="col-lg">
            <div class="card mt-3">
            @if($pendingTransaction->mentorUser->mentors->pic == null)
                <img style="margin: auto;margin-top: 1%" class="profile1-dp card-img-top"  src="{{asset('user.jpeg')}}" alt="Card image cap">
                @else
                <img style="margin: auto;margin-top: 1%" class="profile1-dp card-img-top"  src="{{$pendingTransaction->mentorUser->mentors->pic}}" alt="Card image cap">
                @endif
                <div class="card-body" >
                    <h6 class="card-title p2 text-center" id="text-color"><b>Mentor: {{$pendingTransaction->mentorUser->mentors->fullname()}}</b></h6>
